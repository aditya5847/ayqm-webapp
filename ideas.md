...
- Update the site favicon with an AYQM-branded icon.
...
- Support a unique cover image for each episode and determine how it should be uploaded, stored, and served.
